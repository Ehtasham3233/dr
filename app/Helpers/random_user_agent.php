...
function pure_clean_title_up($string) 
{   
    $string = strtolower($string); //convert string to lower
    $string = trim($string); //convert string to lower
    $string = str_replace('"', "", $string);
    $string = str_replace("'", "", $string);
    $string = str_replace("&quot;", "", $string);
    $string = str_replace("&laquo;", "", $string);
    $string = str_replace("&raquo;", "", $string);
    //$string = preg_replace('!\s+!', ' ', $string); //replace multiple space with single
    $string = preg_replace("/\t/", " ", $string);
    $string = preg_replace("/\s+/", " ", $string);
    $string = str_replace(' ', '-', $string); // Replaces all spaces with hyphens.
    //$string = preg_replace('/-+/', '-', $string); //replace multiple hyphens with single
