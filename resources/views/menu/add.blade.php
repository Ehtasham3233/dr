...
<!-- push external head elements to head -->
    ...
    <div class="container-fluid">
        ...
        <form class="forms-sample" method="POST" action="{{ url('menus/store') }}" >
        @csrf
        <div class="row">
            <!-- start message area-->
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select class="form-control select2" name="is_parent">
                    <option value="0">{{ __('Main menu')}}</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" name="type" required>
                    ...
                    <option value="1">{{ __('External')}}</option>
                </select>
            </div>
            <div class="form-group">
