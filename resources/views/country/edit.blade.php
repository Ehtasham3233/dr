...
<!-- push external head elements to head -->
    ...
    ?>
                ...
                <div class="col-lg-2">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('Edit data of Country')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-8">
                ...
                <div class="col-lg-2">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('countries/list') }}">{{ __('Country List')}}</a></li>
        ...
        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('countries/update') }}" >
        @csrf
