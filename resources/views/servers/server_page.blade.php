            ...
            <div class="row align-items-end">
                <div class="col-lg-2">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Server List')}}</h5>
                            <span>{{ __('Complete list of Server')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-8">
                    ...
                    <button style="color: #fff;background-color: #202C50;border-radius: 10px;font-size: 12px; padding: 8px 16px;"data-toggle="tooltip" data-placement="top" title="Add Server">{{ __('Add Server')}}</button>    
                        </a>  
                    </nav>
                </div>
                <div class="col-lg-2">
    ...
    $(document).ready(function()
    {
        ...
        var dTable = $('#server_table').DataTable({
            ...
            columns: [
                ...
                {data:'status', name: 'status'==1?'Active':'Inactive'},
                {data:'ip', name: 'ip'},
