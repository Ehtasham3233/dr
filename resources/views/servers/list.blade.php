   ...
   <!-- push external head elements to head -->
    ...
    @endpush
     <div class="container-fluid">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ url('servers/add') }}">
                                    <button style="color: #fff;background-color: #202C50;border-radius: 10px;font-size: 12px;  padding: 8px 16px;"data-toggle="tooltip" data-placement="top" title="Add Servers">{{ __('Add Server')}}</button>    
                                </a>
                            </li>
                        </ol>
                    </nav>
       ...
       <!-- <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('servers/fetch') }}" >
        @csrf
        <div class="row">
        <div class="col-md-12">
        <div class="card">
                            ...
                            <table id="simpletable"
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        <td>{{$row['title']}}</td>
                                        <td>
                                           <img  width="60px" height="auto" src="{{url('storage/servers/',$row['img'])}}"> 
                                       </td>
                                        <td>
                                        ...
                                        <td><div class="table-actions">
                                            <a href="{{url('servers/edit/'.$row['id'])}}"><i class="ik ik-edit-2 btn btn-success "data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                            <a href="{{url('servers/delete/'.$row['id'])}}"><i class="ik ik-trash-2 btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                        </div></td>
                                    </tr>
