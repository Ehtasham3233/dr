            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Fatch Moive')}}</h5>
                            <span>{{ __('Fatch movie by url')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Fatch Moive')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>{{ __('Fetch Movie Data')}}</h3>
                    </div>
                    <div class="card-body">
            
                            <form class="forms-sample" method="POST" action="{{ url('movies/fetch') }}" >
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputUsername1">{{ __('Movie URl')}}</label>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <h3>{{ __('Fetch Movie Data')}}</h3>
                            ...
                            <form class="forms-sample" method="POST" action="{{ url('movies/save') }}" >
                            @csrf
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary mr-2">{{ __('Save Movie In Database')}}</button>
                          </form>
                            </div>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="col-sm-6">
                     <div class="card-title"> <h3>{{$drama_details['title_and_url']['drama_title']}}</h3></div>
                      ...
                      @if(count($drama_details['getinfo']['drama_genre'])>0)       
                        <p><b>Genre:</b> Cohabitation; Comedy; Musical; Romance; Web Series; Youth;</p>
                      @endif
