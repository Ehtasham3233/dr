...
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-3">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Episode List')}}</h5>
                            <span>{{ __('Complete list of Drama Episode')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-7">
                ...
                <div class="col-lg-2">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('Drama/list') }}">{{ __('Drama Episode')}}</a></li>
            ...
            <div class="col-md-12">
                <div class="card p-5">
                  <!--   <div class="card-header"><h3>{{ __('Users')}}</h3></div> -->
                    <div class="card-body">
                        <table id="episode_table" class="table">
                            <thead>
                                <tr>
                                    <th>{{ __('Title')}}</th>
                                    <th>{{ __('Url')}}</th>
    ...
    $(document).ready(function()
    {
        ...
        var searchable = [];
        var selectable = []; 
        var drama_id = "{{Request::segment(3)}}";
        var dTable = $('#episode_table').DataTable({
            ...
            ajax: {
                url: "{{url('episode/get-episode-list')}}",
