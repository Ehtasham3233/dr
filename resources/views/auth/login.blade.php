<?php
    ...
    if(isset($settings->admin_dark_logo))
    $admin_logo = asset('storage/site/'.$settings->admin_dark_logo);
    else
    $admin_logo =  asset('img/logo.png');
?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                <a href="{{url('/')}}"><img height="40" src="{{ $admin_logo }}" alt="{{$settings->title}}" ></a>
                            </div>
                            <p>Welcome back! </p>
