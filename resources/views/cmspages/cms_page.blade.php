            ...
            <div class="row align-items-end">
                <div class="col-lg-3">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('CMS Page List')}}</h5>
                            <span>{{ __('Complete list of CMS Pages')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-7">
                    ...
                    <button style="color: #fff;background-color: #202C50;border-radius: 10px;font-size: 12px; padding: 8px 16px;"data-toggle="tooltip" data-placement="top" title="Add CMS Page">{{ __('Add CMS Page')}}</button>    
                        </a>  
                    </nav>
                </div>
                <div class="col-lg-2">
