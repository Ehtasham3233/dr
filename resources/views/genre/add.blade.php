    ...
    @endpush
     <div class="container-fluid">
       <div class="page-header">
            <div class="row align-items-end">
                <div class="col-lg-3">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Genre Add')}}</h5>
                            <span>{{ __('Add data of Genre')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-7">
        ...
        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('genre/store') }}" >
        @csrf
        <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group" style="padding-top: 0.6rem;">
                <button type="submit" style="color: #fff;background-color: #202C50;border-radius: 10px;font-size: 12px; padding: 6px 14px;"data-toggle="tooltip" data-placement="top" title="Add Genre">{{ __('Add Genre')}}</button>
            </div>
            </div>
        </div>
    </div>
