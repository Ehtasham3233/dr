...
<!-- push external head elements to head -->
    ...
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-3">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Edit Tags')}}</h5>
                            <span>{{ __('Edit data of Tags')}}</span>
                        </div>
                    </div>
                </div>
                 <div class="col-lg-7">
                ...
                <div class="col-lg-2">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('tags/list') }}">{{ __('Tags List')}}</a></li>
        ...
        <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('tags/update') }}" >
        @csrf
