   ...
   <!-- push external head elements to head -->
    ...
    @endpush
     <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('slider/add') }}">{{ __('Tags')}}</a></li>
       ...
       <!-- <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('tags/fetch') }}" >
        @csrf
        <div class="row">
        <div class="col-md-12">
        <div class="card">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td><div class="table-actions">
                                            <a href="{{url('tags/edit/'.$row['id'])}}"><i class="ik ik-edit-2 btn btn-success "data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                            <a href="{{url('tags/delete/'.$row['id'])}}"><i class="ik ik-trash-2 btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                        </div></td>
                                    </tr>
