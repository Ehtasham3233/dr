   ...
   <!-- push external head elements to head -->
    ...
    @endpush
     <div class="container-fluid">
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{ url('publisher/add') }}">
                                    <button style="color: #fff;background-color: #202C50;border-radius: 10px;font-size: 12px; padding: 8px 16px;"data-toggle="tooltip" data-placement="top" title="Add Publisher">{{ __('Add Publisher')}}</button>    
                                </a>
                            </li>
                        </ol>
                    </nav>
      ...
      <!--  <form class="forms-sample" enctype="multipart/form-data" method="POST" action="{{ url('publisher/fetch') }}" >
        @csrf
        <div class="row">
        <div class="col-md-12">
        <div class="card">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td><div class="table-actions">
                                            <a href="{{url('publisher/edit/'.$row['id'])}}"><i class="ik ik-edit-2 btn btn-success "data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                            <a href="{{url('publisher/delete/'.$row['id'])}}"><i class="ik ik-trash-2 btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete"></i></a>
                                        </div></td>
                                    </tr>
